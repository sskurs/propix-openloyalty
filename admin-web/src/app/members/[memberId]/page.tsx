...
function MemberProfilePage() {
    ...
    const member = { firstName: 'John', lastName: 'Doe', email: 'john.doe@example.com', referralCode: 'REF123', id: '12345', phoneNumber: '555-555-5555', loyaltyCardNumber: 'LOYAL123', loyaltyTierName: 'GOLD', isActive: true, gender: 'Male', dateOfBirth: '1990-01-01', registrationDate: '2023-01-01' }; // mock member
